...
- `npm run build`: section-level code splitting is active; the initial app JS chunk is 286.89 kB / 90.37 kB gzip, the Navigation section chunk is 30.75 kB / 7.21 kB gzip, the Settings section chunk is 44.44 kB / 9.02 kB gzip, the Community section chunk is 66.07 kB / 11.25 kB gzip, and the prior Vite oversized chunk warning is gone.
